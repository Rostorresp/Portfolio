    ...
    <section class="hero">
        <div class="hero-contenido">
            <div class="hero-imagen">
                <picture>
                    <source srcset="/img/coding-amico.webp" type="image/webp">
                    <img loading="lazy" width="200" height="300" src="/img/coding-amico.png" alt="imagen-main">
                </picture>
            </div>
            ...
            <div class="proyectos-contenedor">
                ...
                <article class="proyectos-articulo">
                    <picture>
                        ...
                        <img src="/img/sitelogo.png" width="500" alt="image-sitelogo">
                    </picture>
                ...
                <article class="proyectos-articulo">
                    <picture>
                        <source srcset="/img/landingcoffee.webp" type="image/webp">
                        <img src="/img/landingcoffee.png" width="500" alt="image-landingcoffe">
                    </picture>
                    <div class="proyectos-detail">
                        <h3>Blog de Café</h3>
                ...
                <article class="proyectos-articulo">
                    <picture>
                        <source srcset="/img/tresenuno.webp" type="image/webp">
                        <img src="/img/tresenuno.png" width="500" alt="image-tresenuno">
                    </picture>
                    <div class="proyectos-detail">
                        <h3>Tres en Raya</h3>
                ...
                <article class="proyectos-articulo">
                    <picture>
                        <source srcset="/img/rockfestivale.webp" type="image/webp">
                        <img src="/img/rockfestivale.png" width="500" alt="image-sitestorefrontend">
                    </picture>
                    <div class="proyectos-detail">
                        <h3>Rock & EDM</h3>
